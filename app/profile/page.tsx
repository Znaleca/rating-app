...
import {
    FaUser, FaStar, FaBookmark, FaCheck, FaGamepad, FaList,
...
export default function ProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-slate-100 font-sans selection:bg-yellow-400 selection:text-black">
            ...
            <main className="w-full px-6 xl:px-16 py-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16 pb-16 border-b border-white/5">
                    ...
                    <div className="lg:col-span-7 flex items-start gap-8">
                        ...
                        <div>
                            <p className="text-[9px] font-black uppercase tracking-[0.5em] text-slate-500 mb-2">Personal Archive</p>
                            ...
                            <div className="flex items-center gap-3 flex-wrap">
                                ...
                                {profile?.email && (
                                    <>
                                        ...
                                        <span className="text-[10px] text-slate-600 font-medium">{profile?.email}</span>
                                    </>
                                )}
                            </div>
                        </div>
                ...
                {filteredItems.length === 0 ? (
                    <div className="py-32 text-center border border-dashed border-white/5">
                        ...
                        <Link href="/browse" className="mt-6 inline-flex items-center gap-2 text-[9px] font-black uppercase tracking-widest text-blue-400 hover:text-white transition-colors">
