...
export default function RegisterPage() {
    ...
    if (success) {
        return (
            <div className="relative min-h-screen bg-[var(--background)] text-[var(--foreground)] font-sans flex items-center justify-center px-4">
                <div className="relative bg-[var(--background)] border border-[var(--border-subtle)] p-10 md:p-14 text-center max-w-md shadow-[20px_20px_0px_rgba(255,255,255,0.02)]">
                    ...
                    <p className="text-[var(--muted-foreground)] text-xs font-bold tracking-widest leading-relaxed mb-8">
                        Check <span className="text-[var(--foreground)]">{email}</span> to activate your account.
                    </p>
                    <Link href="/login" className="text-blue-400 hover:text-[var(--foreground)] text-[10px] font-black uppercase tracking-[0.3em] underline underline-offset-8">
                        Return to Login
                    </Link>
                </div>
            </div>
            ...
            <div className="relative z-10 w-full max-w-lg">
                    ...
                    <div className="relative bg-[var(--background)] border border-[var(--border-subtle)] p-10 md:p-14 shadow-[20px_20px_0px_rgba(255,255,255,0.02)]">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-3">
                                <label className="text-[var(--muted-foreground)] text-[9px] font-black uppercase tracking-[0.4em]">Full Name</label>
                                <div className="relative">
                                    <FaUser className="absolute left-6 top-1/2 -translate-y-1/2 text-[var(--muted-foreground)]" size={14} />
                                    <input
                                        type="text"
                                        required
                                        value={fullName}
                ...
                <div className="mt-12 text-center">
                    <p className="text-[var(--muted-foreground)] text-[10px] font-black uppercase tracking-[0.4em]">
                        Existing member?{" "}
                        <Link href="/login" className="text-blue-400 hover:text-[var(--foreground)] transition-colors ml-2 underline underline-offset-4">
                            Sign In
                        </Link>
                    </p>
                </div>
